...
import buttonSound from '../../../sounds/squishier-button-v3-007_mp3.js';
...
const WAVE_GENERATOR_BUTTON_SOUND_CLIP = new SoundClip( buttonSound, {
 ...
 * @public
 */
Scene.DisturbanceType = Enumeration.byKeys( [ 'PULSE', 'CONTINUOUS' ] );

/**
 * A wave can either be generated by a point source (POINT) or by a plane wave (PLANE).
 * @public
 */
Scene.WaveSpatialType = Enumeration.byKeys( [ 'POINT', 'PLANE' ] );

/**
 * The wave area can contain a barrier with ONE_SLIT, TWO_SLITS or NO_BARRIER at all.
 * @public
 */
Scene.BarrierType = Enumeration.byKeys( [ 'NO_BARRIER', 'ONE_SLIT', 'TWO_SLITS' ] );
