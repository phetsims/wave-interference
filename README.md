...
<a href="https://phet.colorado.edu/sims/html/wave-interference/latest/wave-interference_en.html" target="_blank">Click
here to run "Wave Interference".</a>
...
(5) Open in the browser: `http://localhost/wave-interference/wave-interference_en.html` (You will probably need to
...
(3) Open in the
browser: `http://localhost/wave-interference/build/adapted-from-phet/wave-interference_en_adapted-from-phet.html` (You
...
Help us improve, create a <a href="http://github.com/phetsims/wave-interference/issues/new" target="_blank">New
Issue</a>
